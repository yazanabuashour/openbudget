...
`openbudget` is now bootstrapped as a Go module with a minimal CLI entrypoint and CI checks. The repository is still early-stage scaffolding and does not publish runnable artifacts yet.
